...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage("Đăng ký thành công! Đang chuyển hướng tới trang làm việc...");

      // Tự động đăng nhập và lưu session vào localStorage
      ...
      const msg = err instanceof Error ? err.message : "Đã xảy ra lỗi khi đăng ký";
      setErrorMessage(msg);
    } finally {
      setLoading(false);
    }
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">
            Tạo tài khoản Repurposely AI
          </h1>
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Tự động nhân bản bài viết và video thành chuỗi content viral
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-xl shadow-slate-200/40 dark:border-slate-800 dark:bg-slate-900/90 dark:shadow-none space-y-5">
          ...
          >
            ...
            <span>{demoLoading ? "Đang kết nối..." : "Trải nghiệm nhanh với Tài khoản Khách"}</span>
          </button>
